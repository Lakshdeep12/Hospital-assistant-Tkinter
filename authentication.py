...
box_label = tk.Label(frame, text="Authentication Required", font=box_font, bg="white")
box_label.grid(row=0, column=0, columnspan=2, pady=(20, 10))
...
image_label.pack(side=tk.RIGHT, padx=(10,30), pady=(5,25))
